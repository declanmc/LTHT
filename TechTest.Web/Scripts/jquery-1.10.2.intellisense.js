...
intellisense.annotate(jQuery, {
  ...
  'parseHTML': function() {
    ...
    ///   <param name="keepScripts" type="Boolean">A Boolean indicating whether to toInclude scripts passed in the HTML string</param>
    ///   <returns type="Array" />
    /// </signature>
  },
  'parseJSON': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'outerHeight': function() {
    ...
    ///   <param name="includeMargin" type="Boolean">A Boolean indicating whether to toInclude the element's margin in the calculation.</param>
    ///   <returns type="Integer" />
    /// </signature>
  },
  'outerWidth': function() {
